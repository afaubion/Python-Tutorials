...
# The following group, the part with (From|To|Cc) means that the line has to start
#       with one of the words that are separated by the pipe |.
# That is called the OR operator, and the regex will match if the line starts
# with any of the words in the group.
